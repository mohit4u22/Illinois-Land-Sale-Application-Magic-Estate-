<%@ Page Title="" Language="C#" MasterPageFile="~/MagicEstate.Master" AutoEventWireup="true" CodeBehind="UpdateProperty.aspx.cs" Inherits="Assign5.UpdateProperty" %>
...
<body>
    ...
    <h1>Post Property for Sale</h1><br/>        
        ...
        *Mandatory
            <table>
                <tr>
                    ...
                    <td class="auto-style1">
                        <asp:TextBox ID="TextBox1" runat="server" Width="208px" Enabled="false"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="auto-style1">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ControlToValidate="TextBox7" runat="server" ErrorMessage="Enter a valid email address" ValidationExpression="^[\.\w\-]{2,}@[\.\w\-]+(\.\w\-)*\.(com|org|net|edu|in)$"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="auto-style1">
                        <asp:Label ID="prop_img" runat="server" Text=""></asp:Label>
        ...
        <br/><br/>
        <asp:Button ID="Button1" class="myButton" runat="server" Text="Update Property" OnClick="Button1_Click" />
